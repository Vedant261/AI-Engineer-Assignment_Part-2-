# -*- coding: utf-8 -*-
"""Ai Engineer Assignment pynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1DGhtgqIpgBQEFo29I9V8T84xB4h2V_sN
"""
...
# Load the multi-language model for Hindi (xx_ent_wiki_sm)
# taken from text
nlp = spacy.load("xx_ent_wiki_sm")

# Hindi conversation text
conversation = """
...
sentiment = analyzer.polarity_scores(conversation)
sentiment

#  non-compliance phrases
non_compliance_phrases = {
    "Using Threatening Language": [
        "अगर कल तक पैसे नहीं आए तो मैं खुद तुम्हारे घर आऊंगा।",
        "अगर तुम कल तक पैसे नहीं देते, तो मैं तुम्हारे ऑफिस आऊंगा और सबके सामने तुम्हारी पोल खोल दूंगा।"
    ],
    "Disclosing Debt Information to Third Parties": [
        "अगर तुम कल तक पैसे नहीं देते, तो मैं तुम्हारे ऑफिस आऊंगा और सबके सामने तुम्हारी पोल खोल दूंगा।"
    ],
    "Providing False or Misleading Information": [
        "वरना हम कानूनी कार्रवाई करेंगे।"
    ]
}

# Check for non-compliance instances in the conversation
non_compliance_instances = {
    category: [phrase for phrase in phrases if phrase in conversation]
    for category, phrases in non_compliance_phrases.items()
}
